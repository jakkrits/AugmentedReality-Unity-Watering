Shader "EasyWater5 No Color"
{
	...
	SubShader 
	{
		...
		void surf (Input IN, inout EditorSurfaceOutput o) {
			...
			// float4 Add11=Normalize0 + float4( 1,1,0,0);
			// float4 Multiply10=Add11 * float4( 0.5,0.5,0.5,0.5);
			// float2 Add11= float2(Normalize0.x + 1, Normalize0.y + 1);
